...
from .models import ChatSession, ChatMessage, Store
from . import db
from .utils import run_assistant, run_assistant_for_store
import os
...
def get_bot_response():
    ...
    if store_id:
        ...
        if store and store.assistant_id:
            ...
            bot_response = run_assistant(user_input, ASSISTANT_ID)
    else:
        ASSISTANT_ID = os.getenv("ASSISTANT_ID")
        bot_response = run_assistant(user_input, ASSISTANT_ID)
